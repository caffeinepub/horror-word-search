...
export class Backend implements backendInterface {
    ...
    async getCategories(): Promise<Array<CategoryName>> {
        if (this.processError) {
            try {
    ...
    async getLeaderboard(arg0: CategoryName): Promise<Array<PuzzleTime>> {
        if (this.processError) {
            try {
    ...
    async getPuzzle(arg0: CategoryName): Promise<Category> {
        if (this.processError) {
            try {
    ...
    async submitPuzzleTime(arg0: CategoryName, arg1: Time): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitPuzzleTime(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
